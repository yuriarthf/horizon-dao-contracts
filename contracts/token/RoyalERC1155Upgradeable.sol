...
abstract contract RoyalERC1155Upgradeable is IEIP2981, ERC1155SupplyUpgradeable {
    ...
    function __RoyalERC1155Upgradeable_init(
        string memory uri_,
        address _admin,
        address _owner
        ...
        __RoyalERC1155Upgradeable_init_unchained(_admin, _owner);
    }

    function __RoyalERC1155Upgradeable_init_unchained(address _admin, address _owner) internal onlyInitializing {
