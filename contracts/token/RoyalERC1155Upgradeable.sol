...
import { IEIP2981Upgradeable } from "../interfaces/IEIP2981Upgradeable.sol";
...
abstract contract RoyalERC1155Upgradeable is IEIP2981Upgradeable, SingleApprovableERC1155Upgradeable {
        ...
        returns (bool)
    {
        ...
        return interfaceId == type(IEIP2981Upgradeable).interfaceId || super.supportsInterface(interfaceId);
    }
}
